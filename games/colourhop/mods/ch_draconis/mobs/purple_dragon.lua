...
minetest.register_entity("ch_draconis:fire_eyes", {
	hp_max = 1,
	...
	textures = {"draconis_fire_eyes_green.png"},
	is_visible = true,
...
local function purple_dragon_logic(self)
	...
	if self.hit_debouncer > 0 then
		...
		if self.hit_debouncer == 0 then
			...
			self.shield_regen_timer = mobkit.remember(self, "shield_regen_timer", 0)
	...
	-- Purple dragon should never land..
...
ch_draconis.purple_dragon = ch_draconis.register_dragon("purple", {
	logic = purple_dragon_logic,
	hp = 4
})
